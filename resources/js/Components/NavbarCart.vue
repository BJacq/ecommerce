<template>
    <div class="space-x-8 sm:sl-10 sm:flex mr-10">
        <a href="/shoppingCart" class="relative">
            ...
            <svg xmlns="http://www.w3c.org/2000/svg" class="h-7 w-7 text-sm font-medium leading-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
